...
\begin{lstlisting}[caption={[Topic Model for stolen movie \enquote{The Interview}] Topic Model for stolen movie \enquote{The Interview}}, label={lst:topic-model-interview}, float=h]
